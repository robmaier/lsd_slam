...
extern template class Sophus::SE3<float>;
extern template class Sophus::SE3<double>;

extern template class Sophus::Sim3<float>;
extern template class Sophus::Sim3<double>;
